...
import (
	...
	"github.com/nsyszr/ngvpn/pkg/api"
	"github.com/nsyszr/ngvpn/pkg/devicecontrol"
	"github.com/nsyszr/ngvpn/pkg/manager"
	"github.com/nsyszr/ngvpn/pkg/manager/memory"
...
func (s *server) ServeAPI() {
	...
	apiHandler := api.NewHandler(s.mgr)
	...
	go func() {
		...
		if err := e.Start(fmt.Sprintf("%s:%d", "", 9001)); err != nil {
